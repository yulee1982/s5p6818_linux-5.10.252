...
_mali_osk_errcode_t mali_dma_fence_context_add_waiters(struct mali_dma_fence_context *dma_fence_context,
		struct dma_resv *dma_reservation_object)
{
	...
	ret = dma_resv_get_fences_rcu(dma_reservation_object, &exclusive_fence,
...
void mali_dma_fence_add_reservation_object_list(struct dma_resv *dma_reservation_object,
		struct dma_resv **dma_reservation_object_list,
...
int mali_dma_fence_lock_reservation_object_list(struct dma_resv **dma_reservation_object_list,
		u32 num_dma_reservation_object, struct ww_acquire_ctx *ww_actx)
{
	u32 i;

	struct dma_resv *reservation_object_to_slow_lock = NULL;
...
void mali_dma_fence_unlock_reservation_object_list(struct dma_resv **dma_reservation_object_list,
		u32 num_dma_reservation_object, struct ww_acquire_ctx *ww_actx)
{
	u32 i;
